...
function printAccountsTable(startDate, endDate, report) {
	...
	for (var i = 0; i < accountsTab.rowCount; i++) {	
			...
			|| tRow.value("Kostenstelle") && tRow.value("Zuordnung")) 
		{
			...
			//tableRow.addCell(Banana.SDecimal.subtract(tRow.value("Debit"), tRow.value("Credit")), "alignRight bold", 1);
			tableRow.addCell(tRow.value("Debit"), "alignRight bold", 1);
			tableRow.addCell(tRow.value("Credit"), "alignRight bold", 1);
			tableRow.addCell(tRow.value("Opening"), "alignRight bold", 1);
			tableRow.addCell(tRow.value("Balance"), "alignRight bold", 1);
		}
		else 
		{
			...
			//tableRow.addCell(Banana.SDecimal.subtract(tRow.value("Debit"), tRow.value("Credit")), "alignRight", 1);
			tableRow.addCell(tRow.value("Debit"), "alignRight", 1);
			tableRow.addCell(tRow.value("Credit"), "alignRight", 1);
			tableRow.addCell(tRow.value("Opening"), "alignRight", 1);
			tableRow.addCell(tRow.value("Balance"), "alignRight", 1);
		}
	}
